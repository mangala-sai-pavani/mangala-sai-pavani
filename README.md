...
|:---:|:---:|:---:|
| B.Sc. CS, St. Joseph's College for Women — CGPA 8.0 (2026) | Data Science / SWE Intern @ **CHV Apps** — full-stack WhatsApp Marketing app | Applying for full-stack / backend / SWE roles |
...
<details>
<summary><b>📋 Breakdown by comfort level (click to expand)</b></summary>
<br>

**Working knowledge:** Python · JavaScript · SQL · React.js · Flask · FastAPI · Node.js/Express.js

**Fundamentals:** MySQL · PostgreSQL · OOP · DBMS · DSA · Operating Systems · Computer Networks · SDLC
...
*Team Lead*
Role-based booking system — Admin, Receptionist, Doctor, Patient — with emergency booking, rescheduling with fees, QR check-in, reminders.

`React` `Node.js` `Express.js` `PostgreSQL` `Supabase`

[View Repo →](https://github.com/mangala-sai-pavani/REPO-NAME-HERE)

</td>
<td width="50%">

**💰 Student Budget & Loan Planner**
Income/expense tracking, loan amortization, savings goals, analytics. TF-IDF + Logistic Regression for expense categorization, Random Forest for prediction.

`Python` `FastAPI` `SQLAlchemy` `PostgreSQL` `ML`

[View Repo →](https://github.com/mangala-sai-pavani/student-budget-loan-planner)
...
Full-stack ticket booking with a Flask API and database, seat selection, and a temporary seat/payment hold flow.

`Flask` `React.js` `MySQL` `Bootstrap`
...
E-commerce style storefront — product browsing, responsive UI, REST API integration.

`React` `JSON Server` `REST API`
...
<!-- SNAKE_START -->
<div align="center">
<img src="https://raw.githubusercontent.com/mangala-sai-pavani/mangala-sai-pavani/output/github-contribution-grid-snake.svg" width="100%"/>
</div>
<!-- SNAKE_END -->
